...
$bits=explode("@",$user);
$user=$bits['0'];
$sql="SELECT * FROM level5 WHERE tk_emailid ='$user'";
...
<html>
	...
	<script type="text/javascript">
	 var au=document.getElementById("bg").load();
 au.play();
	function update(){
 ...
 $.post("../../lp/setmegapoints.php",{username:"<?php echo $user; ?>",level:"<?php echo $cl; ?>",megapoints:"<?php echo $megapoints; ?>"},function(){});
	...
	<body onload="init()">
		...
		<div class="exampleoverlay">
			...
			<div class="links">
			 <h1><a href="../level5.php"  alt="next level">Retry</a></h1> 
			 <h1><a href="#lead.php" alt="next level">view leaderboard</a></h1>  
			</div>
