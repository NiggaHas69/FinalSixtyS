...
$username=$bits['0'];
    ...
    $sql="SELECT * FROM level1 WHERE tk_emailid='$username'";
    $query=mysql_query($sql) or die(mysql_error());
    $row=mysql_fetch_assoc($query);
    $played=$row['level_played'];
    if($played == 0)
 {   
   // SendScore("sixty-seconds",100,$username);
    $sql1="UPDATE level1 SET level_played=1 WHERE tk_emailid='$username' ";
...
#light{
 ...
 <div id="light"> <center><span> End of Level One.   </span> <button id="click" > Continue</button><center></div>
<div id="fade"></div>
...
var ry =new Array();
        ...
        rx.push(305);ry.push(395); //water
    rx.push(150);ry.push(475);
    rx.push(675);ry.push(480);
    rx.push(875);ry.push(345);
    rx.push(775);ry.push(105);
    
    rx.push(45);ry.push(260); //feul
    rx.push(280);ry.push(550);
    rx.push(680);ry.push(390);
    rx.push(790);ry.push(198);
    
    rx.push(63);ry.push(395); //food
    rx.push(545);ry.push(490);
    rx.push(790);ry.push(555);
    rx.push(1120);ry.push(230);
    
    rx.push(500);ry.push(250); //oxygen
    
 //array of x coordinates of resources
...
//Resource collision detection piece of stupid fuckin code starts here
            ...
            function remove(i){
            if (have.length==1)return 0;   //if Player does not have resource then only he will grab it 
...
function timedCount() {
    ...
    c = c + 1;
    if(c<60)
    t = setTimeout(function(){ timedCount() }, 1200);
  else stopCount();
}
       ...
       // ctx.drawImage(floor,0,0,1200,700);
          ...
          function draw() {
            ...
            have.splice(oxy,1);
             ...
             if (have[0]==oxy)
             {ctx.drawImage(fue,600,50,80,80);  //CHANGE!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
             vault.push(have[0]);
             have.splice(oxy,1);  
               }
