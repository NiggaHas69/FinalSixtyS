...
$username=$bits['0'];
   ...
   $sql="SELECT * FROM main WHERE tk_emailid='$username'";
...
content = "width=device-width, initial-scale=1.0" />
  <!-- styles -->
  <link rel = "stylesheet" href = "level1/assets/css/overlay.css">  <!-- latest update 7/2/2016  -->
  <link href = "level1/assets/css/bootstrap.css"
rel = "stylesheet" />
  <link href = "level1/assets/css/bootstrap-theme.css"
rel = "stylesheet" />
  <link rel = "stylesheet"
href = "level1/assets/css/slippry.css"> <!-- Slide thing -->
  <link href = "level1/assets/css/style.css"
rel = "stylesheet" /> <!-- Font style and stuff -->
  <link rel = "stylesheet"
href = "level1/assets/color/default.css"> <!-- Colour navbar -->
  <link rel = "stylesheet"
href = "level1/assets/css/w3.css">
  </head> 
  <body>
...
<div id="li">
  ...
  <li  class="current">Username : <?php echo $username ?>
...
<section id = "intro">
  ...
  <li>
  <a href = "#slide1"> <img src = "level1/assets/img/1.jpg"
alt = "We took it for granted all our lifetime"> </a> </li> <li>
  <a href = "#slide2"> <img src = "level1/assets/img/bgimg.png"
alt = "Now all thats left is a minute"> </a> </li> <li style = "height:100%">
  ...
  <br>
  <h1> <font style = "color:gray">  Teknack 2016 </font></h1>
  ...
  <img src = "level1/assets/img/logo2.gif"
...
<div class = "w3-container">
  <br> Survive the longest and show the world(What's left of it) who'
    s boss!Now that you 're ready, Lets Play!<br> </div> </div> </div> </div> </div> 
    <!-- section scoring -->
    <footer>
...
<center>    See you in the leaderboards!</center>
    <br><br>
     <br><br>
    </div>

    </div> </div> </footer> </section><a href = "#"
    class = "scrollup"> <i class = "fa fa-angle-up fa-2x"> </i></a>
<!-- javascript -->
<script src="level1/assets/js/jquery-1.9.1.min.js"></script>
<script src="level1/assets/js/jquery.easing.js"></script>
<script src="level1/assets/js/bootstrap.js"></script>
<script src="level1/assets/js/slippry.min.js"></script>
<script src="level1/assets/js/jquery.nav.js"></script>
<script src="level1/assets/js/jquery.scrollTo.js"></script>
<script src="level1/assets/js/jquery.fancybox.pack.js"></script>   
<script src="level1/assets/js/jquery.fancybox-media.js"></script> 
<script src="level1/assets/js/jquery.nicescroll.min.js"></script> 
  <script>
...
<script src="level1/assets/js/custom.js"></script>   <!-- Smooth scroll -->
