...
$username=$bits['0'];
    $sql="SELECT * FROM level4 WHERE tk_emailid='$username'";
    $query=mysql_query($sql) or die(mysql_error());
    $row=mysql_fetch_assoc($query);
    $played=$row['level_played'];
    if($played == 0)
 {   
    SendScore("sixty-seconds",200,$username);
    $sql1="UPDATE level4 SET level_played=1 WHERE tk_emailid='$username' ";
...
body{
 ...
 <div id="light"> <center><span> End of Level Four.   </span> <button id="click" > Continue</button><center></div>
...
resources[13]=key; resources[i].id='key';
resources[14]=tor; resources[i].id='tor'; 

 
rx.push(543);ry.push(106); //water
rx.push(1000);ry.push(313);
rx.push(676);ry.push(440);
rx.push(510);ry.push(275);

rx.push(729);ry.push(355); //food
rx.push(601);ry.push(600);
rx.push(1142);ry.push(360);
rx.push(728);ry.push(31);

rx.push(283);ry.push(113); //feul
rx.push(989);ry.push(53);
rx.push(494);ry.push(448);
rx.push(345);ry.push(657);

rx.push(800);ry.push(93); //oxygen

rx.push(809);ry.push(435); //key
 rx.push(300);ry.push(200);//torch
...
function init() {
   ...
   collide.load();
          ...
          ctx.drawImage(port1,864,375,50,50);
            ctx.drawImage(port2,260,245,70,70);
            ...
            have.splice(oxy,1);
             ...
             if (have[0]==key)
             {ctx.drawImage(key,100,100,80,80);  
             vault.push(have[0]);
             have.splice(key,1);  
               }
